            ...
            <div className="site-top">
                <div className="site-header clearfix">
                    <div className="container">
                        <a href="#" className="site-brand pull-left"><strong>CapThira, </strong>partagez vos photos</a>
                        ...
                        <div className="row">
                            <form action="" method="post" className="subscribe-form">
                                <div className="col-md-offset-4 col-md-3 col-sm-8">
                                    <input type="email" id="subscribe-email" placeholder="Chercher un ami..." />
                                </div>
                                <div className="col-md-5 col-sm-4">
                                    <input type="submit" id="subscribe-submit" className="button white" value="Subscribe!" />
                                </div>
                            </form>
                        </div>
                    </div>  
