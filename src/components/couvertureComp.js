...
class couvertureComp extends React.Component{
	...
	render(){
        let photoDeCouverture;
        
        if (!this.state.imgConverted){
            photoDeCouverture = <img src={imgParDefault} />
        }
        else{
            // photoDeCouverture = <img src="{`data:image/jpeg;base64,${binaryData}`}"/>
             photoDeCouverture = <img src="{`data:image/jpeg;base64,${this.state.data}`}"/>
        }
		return(
		  <div>
		    <photoDeCouverture />
